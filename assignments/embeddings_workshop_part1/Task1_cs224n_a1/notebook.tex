...
{\color{incolor}In [{\color{incolor}4}]:} \PY{k}{def} \PY{n+nf}{distinct\PYZus{}words}\PY{p}{(}\PY{n}{corpus}\PY{p}{)}\PY{p}{:}
        ...
        \PY{l+s+sd}{    \PYZdq{}\PYZdq{}\PYZdq{}}
            ...
            \PY{n}{flat} \PY{o}{=} \PY{p}{[}\PY{n}{item} \PY{k}{for} \PY{n}{sublist} \PY{o+ow}{in} \PY{n}{corpus} \PY{k}{for} \PY{n}{item} \PY{o+ow}{in} \PY{n}{sublist}\PY{p}{]}
            \PY{n}{corpus\PYZus{}words} \PY{o}{=} \PY{n+nb}{sorted}\PY{p}{(}\PY{n+nb}{list}\PY{p}{(}\PY{n+nb}{set}\PY{p}{(}\PY{n}{flat}\PY{p}{)}\PY{p}{)}\PY{p}{)}
...
{\color{incolor}In [{\color{incolor}6}]:} \PY{k}{def} \PY{n+nf}{compute\PYZus{}co\PYZus{}occurrence\PYZus{}matrix}\PY{p}{(}\PY{n}{corpus}\PY{p}{,} \PY{n}{window\PYZus{}size}\PY{o}{=}\PY{l+m+mi}{4}\PY{p}{)}\PY{p}{:}
        ...
        \PY{l+s+sd}{    \PYZdq{}\PYZdq{}\PYZdq{}}
            ...
            \PY{k}{for} \PY{n}{sentence} \PY{o+ow}{in} \PY{n}{corpus}\PY{p}{:}
                \PY{k}{for} \PY{n}{center\PYZus{}word\PYZus{}pos} \PY{o+ow}{in} \PY{n+nb}{range}\PY{p}{(}\PY{n+nb}{len}\PY{p}{(}\PY{n}{sentence}\PY{p}{)}\PY{p}{)}\PY{p}{:}
                    \PY{n}{center\PYZus{}word\PYZus{}str} \PY{o}{=} \PY{n}{sentence}\PY{p}{[}\PY{n}{center\PYZus{}word\PYZus{}pos}\PY{p}{]} 
                    \PY{n}{center\PYZus{}word\PYZus{}index} \PY{o}{=} \PY{n}{word2Ind}\PY{p}{[}\PY{n}{center\PYZus{}word\PYZus{}str}\PY{p}{]}
                    
                    \PY{c+c1}{\PYZsh{} get a list of strings that contains center word and its window}
                    \PY{n}{window\PYZus{}set} \PY{o}{=} \PY{n}{sentence}\PY{p}{[}
                        \PY{n+nb}{max}\PY{p}{(}\PY{p}{[}\PY{n}{center\PYZus{}word\PYZus{}pos} \PY{o}{\PYZhy{}} \PY{n}{window\PYZus{}size}\PY{p}{,} \PY{l+m+mi}{0}\PY{p}{]}\PY{p}{)}\PY{p}{:}
                        \PY{n+nb}{min}\PY{p}{(}\PY{p}{[}\PY{n}{center\PYZus{}word\PYZus{}pos} \PY{o}{+} \PY{n}{window\PYZus{}size} \PY{o}{+} \PY{l+m+mi}{1}\PY{p}{,} \PY{n+nb}{len}\PY{p}{(}\PY{n}{sentence}\PY{p}{)}\PY{p}{]}\PY{p}{)}
                    \PY{p}{]}
                    \PY{c+c1}{\PYZsh{} remove center word from its window}
                    \PY{n}{window\PYZus{}set} \PY{o}{=} \PY{n+nb}{set}\PY{p}{(}\PY{n}{window\PYZus{}set}\PY{p}{)} \PY{o}{\PYZhy{}} \PY{n+nb}{set}\PY{p}{(}\PY{p}{[}\PY{n}{center\PYZus{}word\PYZus{}str}\PY{p}{]}\PY{p}{)}
                    
                    \PY{k}{for} \PY{n}{word} \PY{o+ow}{in} \PY{n}{window\PYZus{}set}\PY{p}{:}
                        \PY{n}{word\PYZus{}index} \PY{o}{=} \PY{n}{word2Ind}\PY{p}{[}\PY{n}{word}\PY{p}{]}
                        \PY{n}{M}\PY{p}{[}\PY{n}{center\PYZus{}word\PYZus{}index}\PY{p}{,} \PY{n}{word\PYZus{}index}\PY{p}{]} \PY{o}{+}\PY{o}{=} \PY{l+m+mi}{1}
...
{\color{incolor}In [{\color{incolor}10}]:} \PY{k}{def} \PY{n+nf}{plot\PYZus{}embeddings}\PY{p}{(}\PY{n}{M\PYZus{}reduced}\PY{p}{,} \PY{n}{word2Ind}\PY{p}{,} \PY{n}{words}\PY{p}{)}\PY{p}{:}
         ...
         \PY{l+s+sd}{    \PYZdq{}\PYZdq{}\PYZdq{}}
             ...
             \PY{k}{for} \PY{n}{word} \PY{o+ow}{in} \PY{n}{words}\PY{p}{:}
                 \PY{n}{word\PYZus{}index} \PY{o}{=} \PY{n}{word2Ind}\PY{p}{[}\PY{n}{word}\PY{p}{]}
                 \PY{n}{word\PYZus{}x\PYZus{}emb} \PY{o}{=} \PY{n}{M\PYZus{}reduced}\PY{p}{[}\PY{n}{word\PYZus{}index}\PY{p}{,} \PY{l+m+mi}{0}\PY{p}{]}
                 \PY{n}{word\PYZus{}y\PYZus{}emb} \PY{o}{=} \PY{n}{M\PYZus{}reduced}\PY{p}{[}\PY{n}{word\PYZus{}index}\PY{p}{,} \PY{l+m+mi}{1}\PY{p}{]}
                 \PY{n}{plt}\PY{o}{.}\PY{n}{scatter}\PY{p}{(}\PY{n}{word\PYZus{}x\PYZus{}emb}\PY{p}{,} \PY{n}{word\PYZus{}y\PYZus{}emb}\PY{p}{,} \PY{n}{marker}\PY{o}{=}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{x}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{n}{color}\PY{o}{=}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{red}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
                 \PY{n}{plt}\PY{o}{.}\PY{n}{text}\PY{p}{(}\PY{n}{word\PYZus{}x\PYZus{}emb}\PY{p}{,} \PY{n}{word\PYZus{}y\PYZus{}emb}\PY{p}{,} \PY{n}{word}\PY{p}{,} \PY{n}{fontsize}\PY{o}{=}\PY{l+m+mi}{9}\PY{p}{)}
...
documentation}}.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}27}]:} \PY{c+c1}{\PYZsh{} \PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}}
         \PY{c+c1}{\PYZsh{} Write your polysemous word exploration code here.}
         
         \PY{n}{wv\PYZus{}from\PYZus{}bin}\PY{o}{.}\PY{n}{most\PYZus{}similar}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{head}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
...
\begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor}27}]:} [('heads', 0.639326810836792),
          ...
          ('Youssef\_Kanjo', 0.4621504545211792),
          ('arm', 0.4410949647426605),
          ('vice\_president', 0.43873125314712524)]
\end{Verbatim}
...
documentation}} for further assistance.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}28}]:} \PY{c+c1}{\PYZsh{} \PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}}
         \PY{c+c1}{\PYZsh{} Write your synonym \PYZam{} antonym exploration code here.}
         
         \PY{n}{w1} \PY{o}{=} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{easy}\PY{l+s+s2}{\PYZdq{}}
         \PY{n}{w2} \PY{o}{=} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{effortless}\PY{l+s+s2}{\PYZdq{}}
         \PY{n}{w3} \PY{o}{=} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{difficult}\PY{l+s+s2}{\PYZdq{}}
...
Antonyms easy, difficult have cosine distance: 0.4109084948281806
    ...
    \textbf{distance(`easy', `difficult') is small because these words are
placed in same context more often, than (`easy', `effortless'). It's
possible to replace `easy' for `difficult' in many cases (This a
difficult/easy climb). While it's not possible to use `effortless' in
this example.}
...
documentation}}.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}29}]:} \PY{c+c1}{\PYZsh{} Run this cell to answer the analogy \PYZhy{}\PYZhy{} man : king :: woman : x}
...
works!
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}30}]:} \PY{c+c1}{\PYZsh{} \PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}}
         \PY{c+c1}{\PYZsh{} Write your analogy exploration code here.}
         \PY{n}{pprint}\PY{o}{.}\PY{n}{pprint}\PY{p}{(}\PY{n}{wv\PYZus{}from\PYZus{}bin}\PY{o}{.}\PY{n}{most\PYZus{}similar}\PY{p}{(}\PY{n}{positive}\PY{o}{=}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{old}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{buy}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}\PY{p}{,} \PY{n}{negative}\PY{o}{=}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{young}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}\PY{p}{,} \PY{n}{topn}\PY{o}{=}\PY{l+m+mi}{1}\PY{p}{)}\PY{p}{)}
         \PY{c+c1}{\PYZsh{} \PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}}
\end{Verbatim}
...
a:b, and state the (incorrect) value of b according to the word vectors.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}31}]:} \PY{c+c1}{\PYZsh{} \PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}}
         \PY{c+c1}{\PYZsh{} Write your incorrect analogy exploration code here.}
         
         \PY{n}{pprint}\PY{o}{.}\PY{n}{pprint}\PY{p}{(}\PY{n}{wv\PYZus{}from\PYZus{}bin}\PY{o}{.}\PY{n}{most\PYZus{}similar}\PY{p}{(}\PY{n}{positive}\PY{o}{=}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{France}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Spain}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}\PY{p}{,} \PY{n}{negative}\PY{o}{=}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Paris}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}\PY{p}{)}\PY{p}{)}
...
[('Portugal', 0.6797805428504944),
 ...
 ('NAVAL\_STATION\_ROTA', 0.5955053567886353),
 ('Italy', 0.5865946412086487),
 ('Inveravante\_Inversiones\_SL', 0.584383487701416),
 ('Spains', 0.5592354536056519),
 ('Germany', 0.5550059080123901),
 ('Belgium', 0.5511109828948975),
 ('Spaniards', 0.5500147342681885),
 ('Octopus\_oracle\_picks', 0.5494229793548584)]

    \end{Verbatim}

    `France' - `Paris' should be similar to `Spain' - `Madrid' which is not
presented here
...
``woman''. What do you find in the top 10?
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}32}]:} \PY{c+c1}{\PYZsh{} Run this cell}
...
\item
  ...
  \tightlist
  \item
    Neutral: `bosses', `exec'. Appropriate: `manageress'. Biased:
    `receptionist'.
  \end{enumerate}
\item
  \begin{enumerate}
  ...
  \tightlist
  \item
    ``Bosses'' of different sport teams.
  \end{enumerate}
\end{itemize}
...
bias that you discover.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}33}]:} \PY{c+c1}{\PYZsh{} \PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}}
         ...
         \PY{n+nb}{print}\PY{p}{(}\PY{p}{)}
         \PY{n}{pprint}\PY{o}{.}\PY{n}{pprint}\PY{p}{(}\PY{n}{wv\PYZus{}from\PYZus{}bin}\PY{o}{.}\PY{n}{most\PYZus{}similar}\PY{p}{(}\PY{n}{positive}\PY{o}{=}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{men}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{doctor}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}\PY{p}{,} \PY{n}{negative}\PY{o}{=}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{woman}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}\PY{p}{)}\PY{p}{)}
